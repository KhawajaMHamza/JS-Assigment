...
// question 6
// var mixedArray = ["apple", 1, true, "bannana", 2, false];
// question 7
...
// var totalMarks = 500;
// for (var i = 0; i < studentName s.Length ; i++) {
...
// colorNames.push(usecolor);
// document.write(colorNames + "<br>");
// colorNames.unshift("yellow", "purple");
// document.write(colorNames + "<br>");
// colorNames.shift();
// documennt.write(colorNames + "<br>");
// colorNames.pop();
// document.write(colorNames + "<br>");
// var index = prompt("Enter the index to add a color:");
// var usercolor = prompt("Enter a color to add:");
...
// document.write("selcted cities list: <br>" + selectedcities + "<br>");
// question 12
